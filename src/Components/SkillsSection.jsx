...
const handleScroll = () => {
  ...
  const newOpacities = itemRefs.current.map((el, index) => {
    ...
    // ✅ Keep first item active at top
    if (index === 0 && window.scrollY < 50) {
      return 1;
    }
  ...
  return (
    <section className="border-t border-gray-500 w-fit mx-auto py-20 border-b mb-1 lg:mb-0">
      <div className=" mx-auto px-6 flex gap-7 justify-center" >
        ...
        <div className="w-fit flex flex-col gap-5">
          {skills.map((skill, index) => (
            ...
            >
              <p className="text-2xl md:text-4xl lg:text-[56px] font-light leading-tight text-gray-900">
                {skill}
              </p>
            </div>
          ))}
