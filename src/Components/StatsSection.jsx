...
const StatCard = ({ number, suffix, label }) => {
  ...
  return (
    <div 
      ref={ref}
      className="flex lg:w-40 w-40 flex-col items-center justify-center lg:py-4 py-1 bg-[#121212] rounded-2xl border border-white/5 shadow-2xl transition-transform hover:scale-105"
    >
